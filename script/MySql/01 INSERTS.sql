...
INSERT INTO Libro(ISBN, idAutor,idOtroAutor, idGenero, titulo, publicacion)
    ...
    ;
INSERT INTO Prestamo (idPrestamo, idBibliotecario, ISBN, DNI, fechaEntrega, fechaDevolucion, devuelto)
    VALUES (1, 4, 4, 78235164, "2021-05-14", "2021-06-14", 1),
           (2, 2, 3, 23145678, "2021-05-14", "2021-06-14", 0),
           (3, 3, 8, 23145678, "2021-06-28", "2021-07-28", 1),
           (4, 4, 1, 78235164, "2021-07-25", "2021-08-25", 1),
           (5, 4, 2, 87654321, "2021-07-28", "2021-08-28", 0),
           (6, 4, 1, 78235164, "2022-02-11", "2022-03-11", 1),
           (7, 4, 8, 78235164, "2022-03-29", "2022-04-29", 1),
           (8, 3, 3, 87654321, "2022-08-08", "2022-09-08", 0),
           (9, 3, 5, 87654321, "2022-10-31", "2022-11-30", 1),
           (10, 2, 3, 78235164, "2023-01-21", "2023-02-21", 1),
           (11, 1, 7, 12345678,"2023-04-01", "2023-05-01", 1),
           (12, 1, 6, 23145678,"2023-04-17", "2023-05-17", 1),
           (13, 1, 1, 87654321, "2023-07-14", "2023-08-14", 1),
           (14, 1, 1, 87654321, "2023-08-14", "2023-09-14", 1),
           (15, 1, 1, 87654321, "2023-10-14", "2023-11-14", 1),
           (16, 3, 6, 12345678, "2024-11-01", "2024-12-01", 0)
    ;
